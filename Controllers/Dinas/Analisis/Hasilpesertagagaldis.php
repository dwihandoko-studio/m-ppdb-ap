...
use App\Models\Dinas\Analisis\ProseshasilpesertagagaldisModel;
use Config\Services;
...
class Hasilpesertagagaldis extends BaseController
{
    ...
    public function getAll()
    {
        ...
        $datamodel = new ProseshasilpesertagagaldisModel($request);
    ...
    public function index()
    {
        ...
        return view('dinas/analisis/hasilpesertagagaldis/index', $data);
    }
