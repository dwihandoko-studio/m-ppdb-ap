...
use App\Models\Dinas\Analisis\ProsesmutasiModel;
use App\Models\Dinas\Analisis\ProsessekolahmutasiModel;
use App\Models\Dinas\Analisis\ProsessekolahprosesmutasiModel;
use Config\Services;
...
class Prosesmutasi extends BaseController
{
    ...
    public function getAll()
    {
        ...
        $datamodel = new ProsesmutasiModel($request);
    ...
    {
        $request = Services::request();
        $datamodel = new ProsessekolahmutasiModel($request);
        ...
        foreach ($lists as $list) {
            ...
            $action =
                '
                            <a target="_blank" href="' . base_url('dinas/analisis/prosesmutasi/sekolah') . '?token=' . $list->tujuan_sekolah_id_1 . '" class="btn btn-primary btn-sm">
                                <i class="fa fa-eye"></i>
                                <span>Detail</span>
                            </a>';
            $row[] = $action;
    ...
    public function index()
    {
        ...
        return view('dinas/analisis/prosesmutasi/sekolah', $data);
    }
    ...
    public function sekolah()
    {
        ...
        return view('dinas/analisis/prosesmutasi/index', $data);
    }
    ...
    public function proses()
    {
        ...
        return view('dinas/analisis/prosesmutasi/proses', $data);
    }
    ...
    {
        $request = Services::request();
        $datamodel = new ProsessekolahprosesmutasiModel($request);
