...
use App\Models\Dinas\Analisis\ProsesprestasiModel;
use App\Models\Dinas\Analisis\ProsessekolahprestasiModel;
use App\Models\Dinas\Analisis\ProsessekolahprosesprestasiModel;
use Config\Services;
...
class Prosesprestasi extends BaseController
{
    ...
    public function getAll()
    {
        ...
        $datamodel = new ProsesprestasiModel($request);
    ...
    {
        $request = Services::request();
        $datamodel = new ProsessekolahprestasiModel($request);
        ...
        foreach ($lists as $list) {
            ...
            $action =
                '
                            <a target="_blank" href="' . base_url('dinas/analisis/prosesprestasi/sekolah') . '?token=' . $list->tujuan_sekolah_id_1 . '" class="btn btn-primary btn-sm">
                                <i class="fa fa-eye"></i>
                                <span>Detail</span>
                            </a>';
            $row[] = $action;
    ...
    public function index()
    {
        ...
        return view('dinas/analisis/prosesprestasi/sekolah', $data);
    }
    ...
    public function proses()
    {
        ...
        return view('dinas/analisis/prosesprestasi/proses', $data);
    }
    ...
    {
        $request = Services::request();
        $datamodel = new ProsessekolahprosesprestasiModel($request);
