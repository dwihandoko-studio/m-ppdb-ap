...
use App\Models\Dinas\Analisis\ProsessemuatujuanModel;
use App\Models\Dinas\Analisis\ProsessekolahsemuatujuanModel;
use App\Models\Dinas\Analisis\ProsessekolahprosessemuatujuanModel;
use Config\Services;
...
class Prosessemuatujuan extends BaseController
{
    ...
    public function getAll()
    {
        ...
        $datamodel = new ProsessemuatujuanModel($request);
    ...
    {
        $request = Services::request();
        $datamodel = new ProsessekolahsemuatujuanModel($request);
        ...
        foreach ($lists as $list) {
            ...
            $action =
                '
                            <a target="_blank" href="' . base_url('dinas/analisis/prosessemuatujuan/sekolah') . '?token=' . $list->tujuan_sekolah_id_1 . '" class="btn btn-primary btn-sm">
                                <i class="fa fa-eye"></i>
                                <span>Detail</span>
                            </a>';
            $row[] = $action;
    ...
    public function index()
    {
        ...
        return view('dinas/analisis/prosessemuatujuan/sekolah', $data);
    }
    ...
    public function sekolah()
    {
        ...
        return view('dinas/analisis/prosessemuatujuan/index', $data);
    }
    ...
    public function proses()
    {
        ...
        return view('dinas/analisis/prosessemuatujuan/proses', $data);
    }
    ...
    {
        $request = Services::request();
        $datamodel = new ProsessekolahprosessemuatujuanModel($request);
