...
use App\Models\Dinas\Analisis\ProseszonasiModel;
use App\Models\Dinas\Analisis\ProsessekolahzonasiModel;
use App\Models\Dinas\Analisis\ProsessekolahproseszonasiModel;
use Config\Services;
...
class Proseszonasi extends BaseController
{
    ...
    public function getAll()
    {
        ...
        $datamodel = new ProseszonasiModel($request);
    ...
    {
        $request = Services::request();
        $datamodel = new ProsessekolahzonasiModel($request);
    ...
    public function index()
    {
        ...
        return view('dinas/analisis/proseszonasi/sekolah', $data);
    }
    ...
    public function sekolah()
    {
        ...
        return view('dinas/analisis/proseszonasi/index', $data);
    }
    ...
    {
        $request = Services::request();
        $datamodel = new ProsessekolahproseszonasiModel($request);
