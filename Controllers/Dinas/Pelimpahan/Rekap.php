...
// use App\Models\Dinas\Pelimpahan\RekapModel;
// use Config\Services;
...
//             $row[] = $list->fullname;
//             $row[] = $list->nisn;
//             $row[] = $list->nama_sekolah_pelimpahan . ' (' . $list->npsn_sekolah_pelimpahan . ')';
//             $row[] = $list->jarak;
...
//     {
//         $data['title'] = 'Rekapitulasi Peserta Yang Dilimpahkan';
...
//         return view('dinas/pelimpahan/rekap/index', $data);
//     }
...
//                 ->select("b.*, k.lampiran_kk, k.lampiran_lulus, k.lampiran_pernyataan, k.lampiran_prestasi, k.lampiran_afirmasi, k.lampiran_mutasi, k.lampiran_lainnya, a.id as id_pendaftaran, c.nama as nama_sekolah_asal, c.npsn as npsn_sekolah_asal, j.nama as nama_sekolah_pelimpahan, j.npsn as npsn_sekolah_pelimpahan, j.latitude as latitude_sekolah_tujuan, j.longitude as longitude_sekolah_tujuan, a.batal_pendaftar, a.kode_pendaftaran, a.via_jalur, d.nama as nama_provinsi, e.nama as nama_kabupaten, f.nama as nama_kecamatan, g.nama as nama_kelurahan, h.nama as nama_dusun, i.nama as nama_bentuk_pendidikan, ROUND(getDistanceKm(b.latitude,b.longitude,j.latitude,j.longitude), 2) AS jarak")
...
//             $response->data = view('dinas/pelimpahan/rekap/detail-pendaftaran', $data);
