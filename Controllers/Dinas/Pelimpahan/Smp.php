...
use App\Models\Dinas\Pelimpahan\SmpModel;
use Config\Services;
...
class Smp extends BaseController
{
    ...
    public function getAll()
    {
        ...
        $datamodel = new SmpModel($request);
    ...
    public function index()
    {
        ...
        return view('dinas/pelimpahan/smp/index', $data);
    }
    ...
    public function detail() {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->data = view('dinas/pelimpahan/smp/detail', $data);
