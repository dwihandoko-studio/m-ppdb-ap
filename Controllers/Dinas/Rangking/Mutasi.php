...
use App\Models\Dinas\Rangking\MutasiModel;
use Config\Services;
...
class Mutasi extends BaseController
{
    ...
    {
        return redirect()->to(base_url('dinas/rangking/mutasi/data'));
    }
    ...
    public function data()
    {
        ...
        return view('dinas/rangking/mutasi/sekolah', $data);
    }
    ...
    public function detail()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->data = view('dinas/rangking/mutasi/detail', $data);
