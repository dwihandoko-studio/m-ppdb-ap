...
use App\Models\Dinas\Rangking\SwastaModel;
...
class Swasta extends BaseController
{
    ...
    public function getAll()
    {
        ...
        $datamodel = new SwastaModel($request);
    ...
    {
        return redirect()->to(base_url('dinas/rangking/swasta/data'));
    }

    public function data()
    {
        $data['title'] = 'Rekapitulasi Rangking Swasta';
        $Profilelib = new Profilelib();
        $user = $Profilelib->user();
        if ($user->code != 200) {
            delete_cookie('jwt');
    ...
    public function sekolah()
    {
        ...
        $data['title'] = $data['sekolahname']->nama . ' Rekapitulasi Rangking Swasta';
    ...
    public function detail()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->data = view('dinas/rangking/swasta/detail', $data);
    ...
    public function edit()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->code = 200;
            $response->result = $oldData;
            $response->data = view('dinas/rangking/swasta/edit', $data);
            $response->message = "Data ditemukan.";
            return json_encode($response);
        }
    }
