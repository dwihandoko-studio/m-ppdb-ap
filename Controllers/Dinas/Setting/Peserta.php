...
use App\Models\Dinas\PesertaModel;
use Config\Services;
...
class Peserta extends BaseController
{
    ...
    public function getAll()
    {
        ...
        $datamodel = new PesertaModel($request);
    ...
    public function index()
    {
        ...
        return view('dinas/setting/peserta/index', $data);
    }
    ...
    public function import()
    {
        ...
        $data['user'] = $user->data;
        return view('dinas/setting/peserta/import', $data);
    }
