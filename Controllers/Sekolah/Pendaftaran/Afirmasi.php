                    ...
                    if ($decoded) {
                        ...
                        if ($this->_db->affectedRows() > 0) {
                            ...
                            if ($this->_db->affectedRows() > 0) {
                                ...
                                try {
                                    $riwayatLib = new Riwayatlib();
                                    $riwayatLib->insert("Menolak Pendaftaran $name via Jalur Afirmasi dengan No Pendaftaran : " . $cekRegisterTemp['kode_pendaftaran'], "Tolak Pendaftaran Jalur Afirmasi", "tolak");
