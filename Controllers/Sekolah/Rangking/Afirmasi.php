...
use App\Models\Sekolah\Rangking\AfirmasiModel;
use Config\Services;
...
class Afirmasi extends BaseController
{
    ...
    {
        return redirect()->to(base_url('sekolah/rangking/afirmasi/data'));
    }
    ...
    public function data()
    {
        ...
        return view('sekolah/rangking/afirmasi/index', $data);
    }
    ...
    public function detail()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->data = view('sekolah/rangking/afirmasi/detail', $data);
