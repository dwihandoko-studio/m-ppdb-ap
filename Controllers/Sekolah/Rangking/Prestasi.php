...
use App\Models\Sekolah\Rangking\PrestasiModel;
use Config\Services;
...
class Prestasi extends BaseController
{
    ...
    {
        return redirect()->to(base_url('sekolah/rangking/prestasi/data'));
    }
    ...
    public function data()
    {
        ...
        return view('sekolah/rangking/prestasi/index', $data);
    }
    ...
    public function detail()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->data = view('sekolah/rangking/prestasi/detail', $data);
