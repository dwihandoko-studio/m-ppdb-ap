...
use App\Models\Sekolah\Rangking\ZonasiModel;
use Config\Services;
...
class Zonasi extends BaseController
{
    ...
    {
        return redirect()->to(base_url('sekolah/rangking/zonasi/data'));
    }
    ...
    public function data()
    {
        ...
        return view('sekolah/rangking/zonasi/index', $data);
    }
    ...
    public function detail()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->data = view('sekolah/rangking/zonasi/detail', $data);
