    ...
    public function getPendaftaranSekolah()
    {
        ...
        if ($request->getMethod(true) == 'POST') {
            ...
            foreach ($lists as $list) {
                ...
                // $row['npsn'] = $list->npsn;
                $row['nama'] = '<div style="font-size: 13px; vertical-align: inherit;">' . $list->nama_sekolah . '<br/>' . $list->npsn . '<br/>' . $list->nama_kecamatan . '<br/><b>' . ($list->zonasi + $list->afirmasi + $list->mutasi + $list->prestasi) . '</b></div>';
