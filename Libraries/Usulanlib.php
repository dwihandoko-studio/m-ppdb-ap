...
class Usulanlib
{
    ...
    function __construct()
    {
        ...
        $this->tb_usulan  = $this->_db->table('_daftar_usulan_tpg');
        $this->tb_usulan_list_ptk  = $this->_db->table('_daftar_ptk_usulan_tpg');
    }
    ...
    public function getUsulan($id) {
        ...
        $builder->join('_daftar_usulan_tpg b', 'a.kode_usulan = b.kode_usulan', 'LEFT');
        $builder->join('_ptk_tb c', 'a.id_ptk = c.id', 'LEFT');
        $where = "a.kode_usulan = (SELECT kode_usulan FROM _daftar_usulan_tpg WHERE id='$id')";
        $builder->where($where);
        $builder->orderBy('c.nama', 'ASC');
