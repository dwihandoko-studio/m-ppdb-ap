...
namespace App\Libraries\V1\Kecamatan\Usulan;
...
class Usulanlib
{
    ...
    function __construct()
    {
        ...
        $this->tb_usulan  = $this->_db->table('_tb_usulan_tpg');
        $this->tb_usulan_list_ptk  = $this->_db->table('_tb_usulan_detail_tpg');
    }
    ...
    public function getUsulan($id) {
        ...
        $builder = $this->_db->table('_tb_usulan_detail_tpg a');
        ...
        $builder->select($select);
        $builder->join('_tb_usulan_tpg b', 'a.kode_usulan = b.kode_usulan', 'LEFT');
        $builder->join('_ptk_tb c', 'a.id_ptk = c.id', 'LEFT');
