...
{
    protected $table = "data_balikan";
    protected $column_order = array(null, null, 'Nama', 'NISN', 'NIK', 'Nama_ibu_kandung', 'Tanggal_lahir', 'Nama_sekolah_asal', 'Nama_sekolah_tujuan');
    protected $column_search = array('NISN', 'Nama');
