...
class KuotapendaftaranModel extends Model
{
    ...
    protected $order = array('sisa_kuota' => 'desc');
    protected $request;
    protected $db;
    protected $dt;
