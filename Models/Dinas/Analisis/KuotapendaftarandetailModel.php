...
class KuotapendaftarandetailModel extends Model
{
    ...
    private function _get_datatables_query()
    {
        ...
        $select = "b.id, b.nisn, b.fullname, b.peserta_didik_id, b.latitude, b.longitude, a.status_pendaftaran, a.id as id_pendaftaran, c.nama as nama_sekolah_asal, c.npsn as npsn_sekolah_asal, j.nama as nama_sekolah_tujuan, j.npsn as npsn_sekolah_tujuan, j.latitude as latitude_sekolah_tujuan, j.longitude as longitude_sekolah_tujuan, a.kode_pendaftaran, a.via_jalur, a.created_at, ROUND(getDistanceKm(b.latitude,b.longitude,j.latitude,j.longitude), 2) AS jarak";  //14
    ...
    function get_datatables($filter_jenis, $sekolah_id)
    {
        ...
        if ($filter_jenis != "") {
            $this->dt->where('a.status_pendaftaran', $filter_jenis);
        }
