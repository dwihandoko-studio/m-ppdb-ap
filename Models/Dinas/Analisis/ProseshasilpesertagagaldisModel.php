...
class ProseshasilpesertagagaldisModel extends Model
{
    ...
    function get_datatables($filter_jenjang, $filter_jalur)
    {
        ...
        $this->dt->where('a.status_pendaftaran', 3);
