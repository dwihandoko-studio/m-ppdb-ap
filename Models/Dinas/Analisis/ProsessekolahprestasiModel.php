...
class ProsessekolahprestasiModel extends Model
{
    ...
    private function _get_datatables_query()
    {
        ...
        $select = "a.id as id_pendaftaran, a.tujuan_sekolah_id_1, j.nama as nama_sekolah_tujuan, j.npsn as npsn_sekolah_tujuan, a.via_jalur, a.created_at, (SELECT count(peserta_didik_id) FROM _tb_pendaftar WHERE via_jalur = 'PRESTASI' AND tujuan_sekolah_id_1 = a.tujuan_sekolah_id_1) as jumlah_pendaftar, (SELECT prestasi FROM _setting_kuota_tb WHERE sekolah_id = a.tujuan_sekolah_id_1) as jumlah_kuota";  //14
