...
class ProsessekolahproseshasilModel extends Model
{
    ...
    private function _get_datatables_query()
    {
        ...
        $select = "a.id as id_pendaftaran, a.tujuan_sekolah_id_1, a.tujuan_sekolah_id_1 as tujuan_sekolah_id, j.nama as nama_sekolah_tujuan, j.npsn as npsn_sekolah_tujuan, j.status_sekolah, a.via_jalur, a.created_at, count(a.peserta_didik_id) as jumlah_pendaftar";  //14
