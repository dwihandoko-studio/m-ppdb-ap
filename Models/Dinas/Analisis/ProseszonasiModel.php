...
class ProseszonasiModel extends Model
{
    protected $table = "_tb_pendaftar a";
    protected $column_order = array('jarak1', 'b.fullname', 'b.nisn', 'a.kode_pendaftaran', 'a.via_jalur', 'c.nama', 'jarak1');
    ...
    private function _get_datatables_query()
    {
        ...
        $select = "b.id, b.nisn, b.fullname, b.peserta_didik_id, b.latitude, b.longitude, a.id as id_pendaftaran, a.status_pendaftaran, c.nama as nama_sekolah_asal, c.npsn as npsn_sekolah_asal, j.nama as nama_sekolah_tujuan_1, j.npsn as npsn_sekolah_tujuan_1, j.latitude as latitude_sekolah_tujuan_1, j.longitude as longitude_sekolah_tujuan_1, j.nama as nama_sekolah_tujuan_2, j.npsn as npsn_sekolah_tujuan_2, j.latitude as latitude_sekolah_tujuan_2, j.longitude as longitude_sekolah_tujuan_2, j.nama as nama_sekolah_tujuan_3, j.npsn as npsn_sekolah_tujuan_3, j.latitude as latitude_sekolah_tujuan_3, j.longitude as longitude_sekolah_tujuan_3, a.kode_pendaftaran, a.via_jalur, a.created_at, ROUND(getDistanceKm(b.latitude,b.longitude,j.latitude,j.longitude), 2) AS jarak1, ROUND(getDistanceKm(b.latitude,b.longitude,k.latitude,k.longitude), 2) AS jarak2, ROUND(getDistanceKm(b.latitude,b.longitude,l.latitude,l.longitude), 2) AS jarak3";  //14
        ...
        $this->dt->join('ref_sekolah k', 'a.tujuan_sekolah_id_2 = k.id', 'LEFT');
        $this->dt->join('ref_sekolah l', 'a.tujuan_sekolah_id_3 = l.id', 'LEFT');
