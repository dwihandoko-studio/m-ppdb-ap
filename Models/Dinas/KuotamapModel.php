...
class KuotamapModel extends Model
{
    ...
    protected $order = array('status_locked_zonasi' => 'asc');
    ...
    private function _get_datatables_query()
    {
        ...
        $select = "a.*, b.nama as nama_sekolah, c.nama as nama_kecamatan, d.nama as nama_jenjang, (SELECT COUNT(*) FROM _setting_zonasi_tb WHERE sekolah_id = a.sekolah_id AND is_locked = 1) as status_locked_zonasi";
