...
class ZonasiModel extends Model
{
    ...
    protected $order = array('g.nama' => 'asc','b.nama' => 'asc', 'c.nama' => 'asc', 'd.nama' => 'asc', 'e.nama' => 'asc', 'f.nama' => 'asc');
    protected $request;
    protected $db;
    protected $dt;
    ...
    private function _get_datatables_query()
    {
        ...
        $select = "a.*, b.nama as namaProvinsi, c.nama as namaKabupaten, d.nama as namaKecamatan, e.nama as namaKelurahan, f.nama as namaDusun, g.nama as nama_sekolah, g.npsn as npsn_sekolah, h.nama as nama_jenjang";
