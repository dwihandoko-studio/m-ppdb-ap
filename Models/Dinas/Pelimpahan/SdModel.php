...
class SdModel extends Model
{
    ...
    protected $column_search = array('j.npsn', 'b.nisn');
    ...
    private function _get_datatables_query()
    {
        ...
        $select = "b.*, a.id as id_pendaftaran, c.nama as nama_sekolah_asal, c.npsn as npsn_sekolah_asal, c.bentuk_pendidikan_id as jenjang_sekolah_asal, j.nama as nama_sekolah_tujuan, j.npsn as npsn_sekolah_tujuan, a.kode_pendaftaran, a.via_jalur, i.nama as nama_bentuk_pendidikan";
    ...
    function get_datatables()
    {
        ...
        $this->dt->whereNotIn('c.bentuk_pendidikan_id', [5,9,30,31,32,33,38]);
