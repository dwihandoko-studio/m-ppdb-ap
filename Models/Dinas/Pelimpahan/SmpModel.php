...
class SmpModel extends Model
{
    ...
    protected $column_order = array(null, null, 'b.fullname', 'b.nisn', null, null, 'c.nama', 'c.npsn');
    protected $column_search = array('b.nisn', 'j.npsn');
    ...
    private function _get_datatables_query()
    {
        ...
        $select = "b.*, k.lampiran_kk, k.lampiran_lulus, k.lampiran_prestasi, k.lampiran_afirmasi, k.lampiran_mutasi, k.lampiran_lainnya, a.id as id_pendaftaran, c.nama as nama_sekolah_asal, c.npsn as npsn_sekolah_asal, c.bentuk_pendidikan_id as jenjang_sekolah_asal, j.nama as nama_sekolah_tujuan, j.npsn as npsn_sekolah_tujuan, j.latitude as latitude_sekolah_tujuan, j.longitude as longitude_sekolah_tujuan, a.kode_pendaftaran, a.via_jalur, d.nama as nama_provinsi, e.nama as nama_kabupaten, f.nama as nama_kecamatan, g.nama as nama_kelurahan, h.nama as nama_dusun, i.nama as nama_bentuk_pendidikan";
    ...
    function get_datatables()
    {
        ...
        // $this->dt->where('a.status_pendaftaran', 4);
        $this->dt->whereIn('c.bentuk_pendidikan_id', [5,9,30,31,32,33,38]);
