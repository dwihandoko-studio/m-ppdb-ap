...
class PrestasiModel extends Model
{
    ...
    // protected $order = array('l.nilai_akumulative' => 'desc', 'jarak' => 'asc', 'a.created_at' => 'asc');
    protected $request;
    protected $db;
    protected $dt;
    ...
    private function _get_datatables_query()
    {
        ...
        $select = "b.*, l.jenis_prestasi, l.nilai_akumulative, a.id as id_pendaftaran, c.nama as nama_sekolah_asal, c.npsn as npsn_sekolah_asal, j.nama as nama_sekolah_tujuan, j.npsn as npsn_sekolah_tujuan, j.latitude as latitude_sekolah_tujuan, j.longitude as longitude_sekolah_tujuan, a.kode_pendaftaran, a.via_jalur, i.nama as nama_bentuk_pendidikan, ROUND(getDistanceKm(b.latitude,b.longitude,j.latitude,j.longitude), 2) AS jarak";  //14
        ...
        $this->dt->join('tb_nilai_prestasi l', 'l.id = a.id');
        ...
        $this->dt->orderBy('l.nilai_akumulative', 'DESC');
