...
class AntrianModel extends Model
{
    ...
    private function _get_datatables_query()
    {
        ...
        $select = "b.fullname, b.nisn, i.nama as nama_bentuk_pendidikan, j.nama as nama_sekolah_tujuan, j.npsn as npsn_sekolah_tujuan, j.bentuk_pendidikan_id, a.id as id_pendaftaran, a.kode_pendaftaran, a.via_jalur";
