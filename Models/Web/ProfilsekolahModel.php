...
class ProfilsekolahModel extends Model
{
    ...
    protected $column_order = array(null, 'b.nama_sekolah', 'b.npsn', 'b.url_profil');
    protected $column_search = array('nama_sekolah', 'npsn');
    protected $order = array('nama_sekolah' => 'asc');
    protected $request;
    protected $db;
    protected $dt;
