                    ...
                    <div class="col-lg-6 col-7">
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Analisis Proses Jalur Prestasi Sekolah PPDB</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-header border-0" style="padding-bottom: 0px; margin-bottom: 0px;">
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-7">
                                <h5 class="h3 mb-0">ANALISIS PROSES JALUR PRESTASI SEKOLAH PPDB</h5>
                            </div>
