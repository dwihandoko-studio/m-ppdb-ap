                    ...
                    <div class="col-lg-6 col-7">
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Analisis Jalur Zonasi PPDB</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-header border-0" style="padding-bottom: 0px; margin-bottom: 0px;">
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-7">
                                <h5 class="h3 mb-0">ANALISIS JALUR ZONASI PPDB </h5>
                            </div>
                            <div class="col-lg-6 col-7">
                                <div class="row">
                                    <div class="col-lg-6">
                    ...
                    <table id="data-table-id" class="table align-items-center table-flush">
                        <thead>
                            <tr>
                                ...
                                <th>NISN</th>
                                <th>Jalur PPDB</th>
                                <th>Nama Sekolah Pilihan 1</th>
                                <th>Jarak (Km) Pilihan 1</th>
                                <th>Nama Sekolah Pilihan 2</th>
                                <th>Jarak (Km) Pilihan 2</th>
...
<script>
    ...
    $(document).ready(function() {
        ...
        let tableUsulan = $('#data-table-id').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?= base_url('dinas/analisis/prosesterdekat/getAll') ?>",
                "type": "POST",
                "data": function(data) {
                    // data.sekolah_id = '<?php //echo $sekolah_id; 
                                            ?>';
