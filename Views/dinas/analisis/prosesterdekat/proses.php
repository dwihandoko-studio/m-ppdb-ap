                    ...
                    <div class="col-lg-6 col-7">
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Analisis Proses Terdekat Sekolah PPDB</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-header border-0" style="padding-bottom: 0px; margin-bottom: 0px;">
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-7">
                                <h5 class="h3 mb-0">ANALISIS PROSES TERDEKAT SEKOLAH PPDB</h5>
                            </div>
...
<script>
    ...
    function actionDetail(event) {
        $.ajax({
            url: "<?= base_url('dinas/analisis/proses/detail') ?>",
            type: 'POST',
            data: {
                id: event,
            },
    ...
    $(document).ready(function() {
        ...
        let tableUsulan = $('#data-table-id').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?= base_url('dinas/analisis/proses/getAllProses') ?>",
                "type": "POST",
                "data": function(data) {
