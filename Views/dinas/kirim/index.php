                    ...
                    <div class="col-lg-6 col-7">
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Kirim PPDB</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-header border-0" style="padding-bottom: 0px; margin-bottom: 0px;">
                        <div class="row align-items-center">
                                <div class="col-lg-6 col-7">
                                    <h5 class="h3 mb-0">KIRIM PPDB</h5>
                                </div>
...
<script>
    ...
    function actionDetail(event) {
        $.ajax({
            url: "<?= base_url('dinas/kirim/proseskirim') ?>",
            type: 'POST',
            data: {
                id: event,
            },
    ...
    function actionUbah(event) {
        $.ajax({
            url: "<?= base_url('dinas/kirim/ubah') ?>",
            type: 'POST',
            data: {
                id: event,
            },
            ...
            success: function(resul) {
                ...
                if (resul.code !== 200) {
                    ...
                    $('#contentModalLabel').html('UBAH PENDAFTARAN');
    ...
    $(document).ready(function() {
        ...
        let tableUsulan = $('#data-table-id').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?= base_url('dinas/kirim/getAll') ?>",
                "type": "POST",
                "data": function(data) {
