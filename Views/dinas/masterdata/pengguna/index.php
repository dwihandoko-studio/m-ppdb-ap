                    ...
                    <div class="col-lg-6 col-7">
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Manage Pengguna</li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-7">
                                <h5 class="h3 mb-0">MANAGE PENGGUNA</h5>
                            </div>
                            <div class="col-lg-6 col-7">
                                <div class="row align-items-center">
                                    <div class="col-lg-6">
...
<script>
    ...
    function actionAdd(event) {
        $.ajax({
            url: "<?= base_url('dinas/masterdata/pengguna/add') ?>",
            type: 'GET',
            dataType: 'JSON',
            beforeSend: function() {
                $('div.main-content').block({
    ...
    function actionEdit(id) {
        $.ajax({
            url: "<?= base_url('dinas/masterdata/pengguna/edit') ?>",
            type: 'POST',
            data: {
                id: id
            },
    ...
    function actionHapus(event, title = "") {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "<?= base_url('dinas/masterdata/pengguna/hapus') ?>",
                    type: 'POST',
                    data: {
                        id: event,
                    },
    ...
    function actionLock(event, title = "") {
        Swal.fire({
            title: 'Apakah anda yakin ingin mengkunci update data untuk pengguna ini?',
            text: "Lock update data pengguna : " + title,
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
            ...
            if (result.value) {
                $.ajax({
                    url: "<?= base_url('dinas/masterdata/pengguna/lock') ?>",
                    type: 'POST',
                    data: {
                        id: event,
                        nama: title,
    ...
    function actionUnlockVerification(event, title = "") {
        Swal.fire({
            title: 'Apakah anda yakin ingin membuka kunci update data pengguna ini?',
            text: "Buka Kunci Update data pengguna : " + title,
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
            ...
            if (result.value) {
                $.ajax({
                    url: "<?= base_url('dinas/masterdata/pengguna/unlock') ?>",
                    type: 'POST',
                    data: {
                        id: event,
                        nama: title,
    ...
    function actionResetPassword(event, title = "") {
        Swal.fire({
            title: 'Apakah anda yakin ingin mereset password pengguna ini?',
            text: "Reset password pengguna : " + title,
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
            ...
            if (result.value) {
                $.ajax({
                    url: "<?= base_url('dinas/masterdata/pengguna/resetPassword') ?>",
                    type: 'POST',
                    data: {
                        id: event,
                        nama: title,
