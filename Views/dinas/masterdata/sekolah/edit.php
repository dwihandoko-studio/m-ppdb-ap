...
<form id="formAddData" class="form-horizontal form-add-data" method="post">
    ...
    <div class="modal-body" style="padding-top: 0px; padding-bottom: 0px;">
        <div class="col-md-12">
            <div class="form-group npsn-block">
                <label for="npsn" class="form-control-label">NSPN</label>
                <input type="text" class="form-control npsn" value="<?= $data->npsn ?>" name="npsn" placeholder="npsn..." id="_latitude" onfocusin="inputFocus(this);" readonly>
                <div class="help-block npsn"></div>
            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group nama-block">
                <label for="nama" class="form-control-label">Nama Sekolah</label>
                <input type="text" class="form-control nama" value="<?= $data->nama ?>" name="nama" placeholder="nama..." id="_latitude" onfocusin="inputFocus(this);" readonly>
...
<script>
    function saveAdd(event) {
        ...
        if (id === "" || latitude === "" || longitude === "") {
            ...
            $.ajax({
                url: BASE_URL + "/dinas/masterdata/sekolah/editSave",
                type: 'POST',
                data: {
                    id: id,
                    latitude: latitude,
