                    ...
                    <div class="col-lg-6 col-7">
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Manage Referensi Sekolah</li>
                            </ol>
                        </nav>
                    </div>
                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-7">
                                ...
                                <h5 class="h3 mb-0">DATA REFERENSI SEKOLAH</h5>
                            </div>
                            <div class="col-lg-6 col-7">
                                <div class="row">
                                    <div class="col-lg-6 col-7">
...
<script>
    ...
    function actionEdit(event) {
        $.ajax({
            url: "<?= base_url('dinas/masterdata/sekolah/edit') ?>",
            type: 'POST',
            data: {
                id: event,
            },
            ...
            success: function(resul) {
                ...
                if (resul.code !== 200) {
                    ...
                    $('#contentModalLabel').html('EDIT SEKOLAH');
    ...
    $(document).ready(function() {
        ...
        let tableUsulan = $('#data-table-id').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?= base_url('dinas/masterdata/sekolah/getAll') ?>",
                "type": "POST",
                "data": function(data) {
