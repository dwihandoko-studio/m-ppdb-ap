        ...
        <form id="formAddData" class="form-horizontal" method="post">
            <div class="modal-body">
                ...
                <div class="row col-md-12">
                    <div class="col-md-6">
                        <div class="form-group _nama-block">
                            <label for="_nama" class="form-control-label">Nama Sekolah Pelimpahan</label>
                            <input type="text" value="<?= $data->nama_sekolah_pelimpahan ?>" class="form-control judul" id="_nama" readonly />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group _nama-block">
                            <label for="_nama" class="form-control-label">NPSN Sekolah Pelimpahan</label>
                            <input type="text" value="<?= $data->npsn_sekolah_pelimpahan ?>" class="form-control judul" id="_nama" readonly />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group _nama-block">
                            <label for="_nama" class="form-control-label">Jarak</label>
                            <input type="text" value="<?= $data->jarak . ' Km' ?>" class="form-control judul" id="_nama" readonly />
                        </div>
                    </div>
                </div>
                <hr />
