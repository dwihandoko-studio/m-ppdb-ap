                    ...
                    <div class="col-lg-6 col-7">
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Pelimpahan SD</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header border-0">
                        <h3 class="mb-0">PELIMPAHAN SD</h3>
                    </div>
                    <!-- Light table -->
...
<script>
    ...
    function actionPelimpahan(event) {
        $.ajax({
            url: "<?= base_url('dinas/pelimpahan/sd/detail') ?>",
            type: 'POST',
            data: {
                id: event,
            },
    ...
    $(document).ready(function() {
        ...
        let tableUsulan = $('#data-table-id').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?= base_url('dinas/pelimpahan/sd/getAll') ?>",
                "type": "POST",
