            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p style="margin-bottom: 0px;">Klasifikasi: <?= $aduan->klasifikasi ?></p>
                        <p style="margin-top: 0px;">Tujuan: <?= $aduan->tujuan ?></p>
                    </div>
                    <div class="card-header d-flex align-items-center">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="mx-3">
                                ...
                                <small class="d-block text-muted"><?= $aduan->created_at ?>&nbsp;&nbsp;||&nbsp;&nbsp;<?= $aduan->no_hp ?>&nbsp;&nbsp;||&nbsp;&nbsp;<?= $aduan->email ?></small>
                            </div>
                        </div>
