                ...
                <div class="card">
                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-7">
                                <h5 class="h3 mb-0">DATA PENGADUAN</h5>
                            </div>
                            <div class="col-lg-6 col-7">
                                <div class="row align-items-center">
                                    <div class="col-lg-6">
                                        <div class="form-group kecamatan-block">
                                            <label for="filter_kecamatan" class="form-control-label">Filter Klasifikasi</label>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group jenjang-block">
                                            <label for="filter_jenjang" class="form-control-label">Filter Tujuan</label>
...
<script>
    ...
    $(document).ready(function() {
        ...
        let tableUsulan = $('#data-table-id').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?= base_url('dinas/pengaduan/getAll') ?>",
                "type": "POST",
                "data": function(data) {
                    data.filter_klasifikasi = $('#filter_kecamatan').val();
                    data.filter_tujuan = $('#filter_jenjang').val();
                }
            },
            language: {
                paginate: {
