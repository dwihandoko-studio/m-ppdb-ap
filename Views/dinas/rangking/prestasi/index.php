                    ...
                    <div class="col-lg-6 col-7">
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Ranking Prestasi PPDB</li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <div class="container-fluid mt--6">
                ...
                <div class="card">
                    ...
                    <div class="card-header border-0" style="padding-bottom: 0px; margin-bottom: 0px;">
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-7">
                                <h5 class="h3 mb-0">RANGKING PRESTASI PPDB</h5>
                            </div>
        ...
        <div class="modal fade" id="contentModalUpdate" tabindex="-1" role="dialog" aria-labelledby="contentModalUpdateLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-update-loading">
                    <div class="modal-header">
