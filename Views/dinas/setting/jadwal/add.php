...
<script>
    function saveAdd(event) {
        ...
        if (tgl_awal_pendaftaran_zonasi === "" || tgl_akhir_pendaftaran_zonasi === "" || tgl_awal_verifikasi_zonasi === "" || tgl_akhir_verifikasi_zonasi === "" || tgl_awal_analisis_zonasi === "" || tgl_akhir_analisis_zonasi === "" || tgl_pengumuman_zonasi === "" || tgl_awal_daftar_ulang_zonasi === "" || tgl_akhir_daftar_ulang_zonasi === "") {
            return;
        }
        ...
        $.ajax({
            url: BASE_URL + "/dinas/setting/penjadwalan/addSave",
            type: 'POST',
            data: {
    ...
    $(document).ready(function() {
        ...
        initializeDatetime('_tgl_awal_pendaftaran_zonasi', today.getFullYear() + '-06-28');
        initializeDatetime('_tgl_akhir_pendaftaran_zonasi', today.getFullYear() + '-07-02');
        initializeDatetime('_tgl_awal_verifikasi_zonasi', today.getFullYear() + '-06-28');
        initializeDatetime('_tgl_akhir_verifikasi_zonasi', today.getFullYear() + '-07-02');
        initializeDatetime('_tgl_awal_analisis_zonasi', today.getFullYear() + '-07-03');
        initializeDatetime('_tgl_akhir_analisis_zonasi', today.getFullYear() + '-07-03');
        initializeDatetime('_tgl_pengumuman_zonasi', today.getFullYear() + '-07-04');
        initializeDatetime('_tgl_awal_daftar_ulang_zonasi', today.getFullYear() + '-07-05');
        initializeDatetime('_tgl_akhir_daftar_ulang_zonasi', today.getFullYear() + '-07-06');
        initializeDatetime('_tgl_awal_pendaftaran_afirmasi', today.getFullYear() + '-06-28');
        initializeDatetime('_tgl_akhir_pendaftaran_afirmasi', today.getFullYear() + '-07-02');
        initializeDatetime('_tgl_awal_verifikasi_afirmasi', today.getFullYear() + '-06-28');
        initializeDatetime('_tgl_akhir_verifikasi_afirmasi', today.getFullYear() + '-07-02');
        initializeDatetime('_tgl_awal_analisis_afirmasi', today.getFullYear() + '-07-03');
        initializeDatetime('_tgl_akhir_analisis_afirmasi', today.getFullYear() + '-07-03');
        initializeDatetime('_tgl_pengumuman_afirmasi', today.getFullYear() + '-07-04');
        initializeDatetime('_tgl_awal_daftar_ulang_afirmasi', today.getFullYear() + '-07-05');
        initializeDatetime('_tgl_akhir_daftar_ulang_afirmasi', today.getFullYear() + '-07-06');
        initializeDatetime('_tgl_awal_pendaftaran_prestasi', today.getFullYear() + '-06-28');
        initializeDatetime('_tgl_akhir_pendaftaran_prestasi', today.getFullYear() + '-07-02');
        initializeDatetime('_tgl_awal_verifikasi_prestasi', today.getFullYear() + '-06-28');
        initializeDatetime('_tgl_akhir_verifikasi_prestasi', today.getFullYear() + '-07-02');
        initializeDatetime('_tgl_awal_analisis_prestasi', today.getFullYear() + '-07-03');
        initializeDatetime('_tgl_akhir_analisis_prestasi', today.getFullYear() + '-07-03');
        initializeDatetime('_tgl_pengumuman_prestasi', today.getFullYear() + '-07-04');
        initializeDatetime('_tgl_awal_daftar_ulang_prestasi', today.getFullYear() + '-07-05');
        initializeDatetime('_tgl_akhir_daftar_ulang_prestasi', today.getFullYear() + '-07-06');
        initializeDatetime('_tgl_awal_pendaftaran_mutasi', today.getFullYear() + '-06-28');
        initializeDatetime('_tgl_akhir_pendaftaran_mutasi', today.getFullYear() + '-07-02');
        initializeDatetime('_tgl_awal_verifikasi_mutasi', today.getFullYear() + '-06-28');
        initializeDatetime('_tgl_akhir_verifikasi_mutasi', today.getFullYear() + '-07-02');
        initializeDatetime('_tgl_awal_analisis_mutasi', today.getFullYear() + '-07-03');
        initializeDatetime('_tgl_akhir_analisis_mutasi', today.getFullYear() + '-07-03');
        initializeDatetime('_tgl_pengumuman_mutasi', today.getFullYear() + '-07-04');
        initializeDatetime('_tgl_awal_daftar_ulang_mutasi', today.getFullYear() + '-07-05');
        initializeDatetime('_tgl_akhir_daftar_ulang_mutasi', today.getFullYear() + '-07-06');
        // initializeDatetime('_tgl_awal_pendaftaran_zonasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_akhir_pendaftaran_zonasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_awal_verifikasi_zonasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_akhir_verifikasi_zonasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_awal_analisis_zonasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_akhir_analisis_zonasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_pengumuman_zonasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_awal_daftar_ulang_zonasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_akhir_daftar_ulang_zonasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_awal_pendaftaran_afirmasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_akhir_pendaftaran_afirmasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_awal_verifikasi_afirmasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_akhir_verifikasi_afirmasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_awal_analisis_afirmasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_akhir_analisis_afirmasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_pengumuman_afirmasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_awal_daftar_ulang_afirmasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_akhir_daftar_ulang_afirmasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_awal_pendaftaran_prestasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_akhir_pendaftaran_prestasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_awal_verifikasi_prestasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_akhir_verifikasi_prestasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_awal_analisis_prestasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_akhir_analisis_prestasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_pengumuman_prestasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_awal_daftar_ulang_prestasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_akhir_daftar_ulang_prestasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_awal_pendaftaran_mutasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_akhir_pendaftaran_mutasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_awal_verifikasi_mutasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_akhir_verifikasi_mutasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_awal_analisis_mutasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_akhir_analisis_mutasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_pengumuman_mutasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_awal_daftar_ulang_mutasi', new Date().toLocaleDateString('fr-CA'));
        // initializeDatetime('_tgl_akhir_daftar_ulang_mutasi', new Date().toLocaleDateString('fr-CA'));
