                    ...
                    <div class="col-lg-8 col-7">
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Detail Profil Sekolah</li>
                            </ol>
                        </nav>
                    </div>
                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-lg-8 col-7">
                                ...
                                <h5 class="h3 mb-0">DETAIL PROFIL SEKOLAH || <?= $sekolah->nama ?></h5>
                            </div>
                            <!-- <div class="col-lg-4 col-5 text-right">
...
<script>
    ...
    $(document).ready(function() {
        ...
        let tableUsulan = $('#data-table-id').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?= base_url('dinas/setting/profilsekolah/getAllPanitia') ?>",
                "type": "POST",
                "data": function(data) {
                    data.sekolah = '<?= $sekolah->id ?>';
                }
            },
            language: {
                paginate: {
