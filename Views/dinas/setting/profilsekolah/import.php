                    ...
                    <div class="col-lg-6 col-7">
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item"><a href="<?= base_url('dinas/setting/profilsekolah'); ?>">Setting Profil Sekolah</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Import Profil Sekolah</li>
                            </ol>
                        </nav>
                    </div>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header border-0 mb--5">
                        <h3 class="mb-0">Import Data Profil Sekolah</h3>
                        <br>
                        ...
                        <section>
                            <form id="formAdd" method="post" enctype="multipart/form-data">
                                <div class="content-loaded">
                                    <h6 class="text-uppercase text-muted ls-1 mb-1">IMPORT DATA PROFIL SEKOLAH</h6>
                                    <div class="row clearfix">

                                        <!-- <div class="col-lg-6">
                                                <div class="form-group _jenis_aksi-block">
                                                    <label for="_jenis_aksi" class="form-control-label">Pilih Jenis Upload</label>
                                                    <select class="form-control jenis-aksi" name="_jenis_aksi" id="_jenis_aksi" data-toggle="select22" title="Simple select" data-live-search="true" data-live-search-placeholder="Search ..." required>
                                                        <option value="">-- Pilih --</option>
                                                        <option value="lolos">Lolos Matching SIMTUN</option>
                                                        <option value="gagal">Tidak Lolos Matcing SIMTUN</option>
                                                    </select>
                                                    <div class="invalid-feedback _jenis_aksi">Pilihan Jenis Upload an.</div>
                                                </div>
                                            </div> -->
                                        <div class="col-lg-8">
        ...
        $('#simpan-add').on('click', function(e) {
            ...
            if (fileName === "") {
                ...
                $.ajax({
                    ...
                    url: "<?= base_url('dinas/setting/profilsekolah/uploadData') ?>",
                    type: 'POST',
                    data: formUpload,
                    contentType: false,
                    cache: false,
                            ...
                            let sendToServer = function(lines, index) {
                                if (index > lines.length - 1) {
                                    ...
                                    Swal.fire(
                                        ...
                                        document.location.href = "<?= base_url('dinas/setting/profilsekolah'); ?>";
                                    })
                                ...
                                $.ajax({
                                    url: "<?= base_url('dinas/setting/profilsekolah/importData'); ?>",
                                    type: 'POST',
                                    data: {
                                        jenis: item.jenis,
                                        nuptk: item.nuptk,
                                        ...
                                        keterangan_info_gtk: item.keterangan_info_gtk,
