                    ...
                    <div class="col-lg-6 col-7">
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item"><a href="<?= base_url('dinas/setting/zonasi'); ?>">Setting Zonasi Sekolah</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Import Zonasi Sekolah</li>
                            </ol>
                        </nav>
                    </div>
                            ...
                            let sendToServer = function(lines, index) {
                                if (index > lines.length - 1) {
                                    ...
                                    Swal.fire(
                                        ...
                                        document.location.href = "<?= base_url('dinas/setting/zonasi'); ?>";
                                    })
                                ...
                                $.ajax({
                                    url: "<?= base_url('dinas/setting/zonasi/importData'); ?>",
                                    type: 'POST',
                                    data: {
                                        npsn: item.npsn,
