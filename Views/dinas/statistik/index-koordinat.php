                    ...
                    <div class="col-lg-6 col-7">
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Rekapitulasi Pelaksanaan</li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-7">
                                <h5 class="h3 mb-0">DATA PELAKSANAAN</h5>
                            </div>
                            <div class="col-lg-6 col-7">
                                <div class="row align-items-center">
                                    <!-- <div class="col-lg-6">
                            ...
                            <table id="data-table-id" class="table align-items-center table-flush">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-orderable="false">NPSN Sekolah Asal</th>
                                        <th data-orderable="false">Nama Sekolah Asal</th>
                                        <th data-orderable="false">NPSN Sekolah Tujuan</th>
                                        <th data-orderable="false">Nama Sekolah Tujuan</th>
                                        <th data-orderable="false">Jarak (Km)</th>
                                        <!-- <th colspan="6" style="text-align: center;" data-orderable="false">Jumlah Pendaftar</th> -->
                                    </tr>
                                    <!-- <tr>
                                        <th rowspan="2" data-orderable="false">Jalur Afirmasi</th>
                                        <th colspan="3" style="text-align: center;" data-orderable="false">Jalur Zonasi</th>
                                        <th rowspan="2" data-orderable="false">Jalur Mutasi</th>
                                        <th rowspan="2" data-orderable="false">Jalur Prestasi</th>
                                    </tr> -->
                                    <!-- <tr>
