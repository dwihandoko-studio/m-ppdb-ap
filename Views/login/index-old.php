...
<head>
    ...
    <meta property="og:url" content="<?= getenv('web.meta.url') ? getenv('web.meta.url') :  'https://handokowae.my.id' ?>" />
    ...
    <title><?= $title; ?> || <?= getenv('web.meta.title') ? getenv('web.meta.title') : 'LAYANAN' ?></title>
    <script>
