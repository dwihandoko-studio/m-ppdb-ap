...
<body class="login-page">
    <div class="login-box">
        ...
        <div class="card">
            <div class="body">
                <form id="sign_in" method="POST" action="<?= base_url('auth/newpasswordfirslogin'); ?>">
                    <div class="msg">Silahkan masukkan password baru anda.</div>
                    <?php
                    if (isset($error)) { ?>
                    ...
                    ?>
                    <?php if (!isset($errorExpired)) { ?>
                    <div class="input-group">
                        <span class="input-group-addon">
                            <i class="material-icons">lock</i>
                        </span>
                        <div class="form-line">
                            <input type="password" class="form-control" name="newPassword" placeholder="Password" required autofocus>
                        </div>
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">
                        ...
                        <div class="form-line">
                            <input type="password" class="form-control" name="retypeNewPassword" placeholder="Retype Password" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-4">
                    ...
                    <div class="row">
                        <div class="col-xs-4">
                            <a href="<?=base_url('auth/expired');?>" class="btn btn-block bg-pink waves-effect">KEMBALI</a>
                        </div>
                    </div>
                    <?php } ?>
                </form>
