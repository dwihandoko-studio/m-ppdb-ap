...
<body class="login-page">
    <div class="login-box">
        ...
        <div class="card">
            <div class="body">
                <form id="sign_in" method="POST" action="<?= base_url('auth/resetpassword'); ?>">
                    <div class="msg">Silahkan masukkan email anda yang sudah terverifikasi, untuk mereset akun.</div>
                    <?php
                    if (isset($error)) { ?>
