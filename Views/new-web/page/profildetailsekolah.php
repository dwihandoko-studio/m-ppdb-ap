...
<section class="pricing-section centred _profil_sekolah" id="_profil_sekolah">
    <div class="container" style="margin-top: 100px;">
        <div class="sec-title center">
            ...
            <p>Informasi profil <?= (isset($sekolah)) ? $sekolah->nama_sekolah : ' sekolah' ?> pada pelaksanaan PPDB Tahun 2023 Kab. Lampung Tengah, sebagai berikut:</p>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-6 col-md-12" style="text-align: left !important; padding-left: 60px;">
            ...
            <div class="col-lg-12" style="margin-top: 40px;">
                <div class="cardcus loading-content-card">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <h4 style="margin-bottom: 20px;">INFORMASI PANITIA PPDB <?= (isset($sekolah)) ? $sekolah->nama_sekolah . " || " . $sekolah->npsn : ' SEKOLAH' ?></h4>
