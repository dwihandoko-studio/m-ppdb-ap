                ...
                <div id="content_block_51">
                    <div class="content-box">
                        <div class="donation-box">
                            ...
                            <!-- </div> -->
                            <div class="row">
                                <div class="btn-box btncekdata" style="display: block; margin-right: 20px;">
                ...
                <div id="content_block_51">
                    <div class="content-box">
                        <div class="donation-box">
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" onfocus="inputFocus(this)" name="_nik" id="_nik" placeholder="" style="background: transparent; border: 1px solid #fff !important; border-radius: 10px; color: #fff; font-size: 16px; font-weight: 400; height: 50px; outline: medium none;">
                                        <div class="help-block _nik"></div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <p style="color: #fff;">No Kartu Keluarga (KK)</p>
                                        <input type="text" onfocus="inputFocus(this)" name="_kk" id="_kk" placeholder="" style="background: transparent; border: 1px solid #fff !important; border-radius: 10px; color: #fff; font-size: 16px; font-weight: 400; height: 50px; outline: medium none;">
                            ...
                            <!-- </div> -->
                            <div class="row">
                                <div class="btn-box btncekdatabelumsekolah" style="display: block; margin-right: 20px;">
