            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="formcus-row">
                    <div class="formcus-group col-md-12">
                        <div class="row">
                            <div class="col-md-4">
                                <button id="btncekdata" type="button" style="min-width: 100%; max-height: 40px; padding: 10px;" onclick="cancelConfirm(this)" class="btn btn-block btn-warning">BATAL</button>
                            </div>
                            <div class="col-md-8">
