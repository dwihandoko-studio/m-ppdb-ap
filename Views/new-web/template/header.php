...
<div class="mobile-menu">
    ...
    <nav class="menu-box">
        ...
        <div class="btn-box1 _login_button" style="position: relative; float: left; margin: 65px 0px 0px 70px;"><a href="javascript:actionLoginButton(this);" style="padding: 10px 18px;">Login</a></div>
