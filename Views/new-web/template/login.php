    ...
    <div class="popup-inner">
        <div class="container">
            <div class="donate-form-area" style="background: linear-gradient(130deg, #4527a4 15%, #ff0000 100%);">
                ...
                <h4 style="color: #fff;background: rgb(255 255 255 / 19%);padding: 10px; border-radius: 20px; box-shadow: 10px 10px 10px rgba(0, 0, 0, 0.1);"><span>Untuk Login Panitia Sekolah, silahkan login menggunakan <br>email dan password yang sudah didaftarkan pada layanan.</span></h4>
