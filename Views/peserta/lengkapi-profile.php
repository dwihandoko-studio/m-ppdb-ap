                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group _alamat-block">
                                            ...
                                            <textarea class="form-control alamat" name="_alamat" id="_alamat" onFocus="inputFocus(this);" required><?= $alamat ?></textarea>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" id="file-error">
                                            <h5>Pass Foto<span class="required">*</span></h5>
                                            <div class="controls">
...
<script>
    ...
    function loadFileImage() {
        ...
        if (input.files && input.files[0]) {
            ...
            if (file.size > 1 * 512 * 1000) {
                ...
                Swal.fire(
                    'Warning!!!',
                    "Ukuran file tidak boleh lebih dari 512 Kb.",
                    'warning'
                );
                return;
            }
    ...
    function actionSave(event) {
        if (!loading) {
            ...
            const foto = document.getElementsByName('_file')[0].value;
