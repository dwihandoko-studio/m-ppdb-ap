            ...
            <div class="col">
                ...
                <div class="card loading-content">
                    <div class="card-header">
                        <h5 class="h3 mb-0">PENDAFTARAN Melalui Jalur AFIRMASI</h5>
                        <p>Daftar Sekolah Yang Dalam Ruang Lingkup Afirmasi.</p>
                    </div>
...
<script>
    ...
    function cariData(event) {
        ...
        if (cari !== "") {
            $.ajax({
                url: "<?= base_url('peserta/pendaftaran/afirmasi/getAll') ?>",
                type: 'POST',
                data: {
                    keyword: cari,
                    page: "1",
    ...
    function aksiDaftar(id, name) {
        Swal.fire({
            ...
            text: "Daftar ke sekolah " + name + " melalui jalur Afirmasi.",
            ...
            if (result.value) {
                $.ajax({
                    url: "<?= base_url('peserta/pendaftaran/afirmasi/aksidaftar') ?>",
                    type: 'POST',
                    data: {
                        id: id,
                        name: name
