                    ...
                    <div class="col-lg-6 col-7">
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Jalur Swasta</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="col">
                ...
                <div class="card loading-content">
                    <div class="card-header">
                        <h5 class="h3 mb-0">PENDAFTARAN Melalui Jalur SWASTA</h5>
                        <p>Daftar Sekolah Swasta Yang Tersedia.</p>
                    </div>
                    ...
                    <div class="card-body">
                        <?php if (isset($error)) { ?>
                            ...
                            <?php } else { ?>
                                <?php if (isset($warning)) { ?>
                                    <ul class="list-group list-group-flush list my--3 content_swasta" id="content_swasta">
...
<script>
    ...
    function cariData(event) {
        ...
        if (cari !== "") {
            $.ajax({
                url: "<?= base_url('peserta/pendaftaran/swasta/getAll') ?>",
                type: 'POST',
                data: {
                    keyword: cari,
                    page: "1",
            ...
            success: function(resul) {
                ...
                if (resul.code !== 200) {
                    if (resul.code === 401) {
                        ...
                        $('.content_swasta').html('<li><center>Tidak ada data.</center></li>');
                        $('.content_pagination').html('');
                    }
                } else {
                    $('.content_swasta').html(resul.data);
                    $('.content_pagination').html(resul.pagination);
                }
            },
            error: function() {
    ...
    function aksiDaftar(id, name) {
        Swal.fire({
            ...
            text: "Daftar ke sekolah " + name + " melalui jalur Swasta.",
            ...
            if (result.value) {
                $.ajax({
                    url: "<?= base_url('peserta/pendaftaran/swasta/aksidaftar') ?>",
                    type: 'POST',
                    data: {
                        id: id,
                        name: name
