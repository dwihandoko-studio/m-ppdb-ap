                    ...
                    <div class="col-lg-6 col-7">
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Konfirmasi Daftar Ulang</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header border-0">
                        <h3 class="mb-0">KONFIRMASI DAFTAR ULANG</h3>
                    </div>
                    <!-- Light table -->
...
<script>
    ...
    function actionKonfirmasi(id, name) {
        Swal.fire({
            title: 'Apakah anda yakin peserta didik tersebut siap untuk sekolah di sekolah anda?',
            text: "Konfirmasikan Peserta Didik An. : " + name,
            ...
            if (result.value) {
                $.ajax({
                    url: "<?= base_url('sekolah/konfirmasi/aksiverifikasi') ?>",
                    type: 'POST',
                    data: {
                        id: id,
                        name: name
    ...
    $(document).ready(function() {
        ...
        let tableUsulan = $('#data-table-id').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?= base_url('sekolah/konfirmasi/getAll') ?>",
                "type": "POST",
