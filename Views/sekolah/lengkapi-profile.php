                                ...
                                <div class="row">
                                                ...
                                                <?php if (isset($kecamatans)) {
                                                    if (count($kecamatans) > 0) {
                                                        ...
                                                        foreach ($kecamatans as $key => $value) { ?>
                                                            <option value="<?= $value->id ?>" <?= (isset($user)) ? (isset($user->kecamatan) ? (($user->kecamatan == $value->id) ? 'selected' : '') : '') : '' ?>><?= $value->nama ?></option>
                                                <?php }
                                                    } else {
                                                ...
                                                <?php if (isset($kelurahans)) {
                                                    if (count($kelurahans) > 0) {
                                                        ...
                                                        foreach ($kelurahans as $key => $value) { ?>
                                                            <option value="<?= $value->id ?>" <?= (isset($user)) ? (isset($user->kelurahan) ? (($user->kelurahan == $value->id) ? 'selected' : '') : '') : '' ?>><?= $value->nama ?></option>
                                                <?php }
                                                    } else {
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group _alamat-block">
                                            ...
                                            <textarea class="form-control alamat" name="_alamat" id="_alamat" onFocus="inputFocus(this);" required><?= (isset($user)) ? (isset($user->alamat) ? $user->alamat : '') : '' ?></textarea>
...
<script>
    ...
    $('#_kirim_permohonan').on('click', function() {
        ...
        $.ajax({
            ...
            url: BASE_URL + "/sekolah/user/updateBiodata",
            type: 'POST',
            data: formUpload,
            contentType: false,
            cache: false,
