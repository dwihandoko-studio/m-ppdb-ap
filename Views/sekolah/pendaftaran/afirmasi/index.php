                    ...
                    <div class="col-lg-6 col-7">
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Jalur Afirmasi</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card loading-content">
                    <div class="card-header">
                        <h5 class="h3 mb-0">PENDAFTAR Melalui Jalur AFIRMASI</h5>
                        <p>Daftar Peserta Yang Mendaftar Melalui Jalur Afirmasi.</p>
                    </div>
...
<script>
    ...
    function cariData(event) {
        ...
        if (cari !== "") {
            $.ajax({
                url: "<?= base_url('sekolah/pendaftaran/afirmasi/getAll') ?>",
                type: 'POST',
                data: {
                    keyword: cari,
                    page: "1",
    ...
    function verifikasi(id) {
        $.ajax({
            url: "<?= base_url('sekolah/pendaftaran/afirmasi/detail') ?>",
            type: 'POST',
            data: {
                id: id,
            },
    ...
    function saveTolakVerifikasi() {
        ...
        $.ajax({
            url: "<?= base_url('sekolah/pendaftaran/afirmasi/aksitolakverifikasi') ?>",
            type: 'POST',
            data: {
                id: id,
                name: name,
    ...
    function aksiVerifikasi(id, name) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "<?= base_url('sekolah/pendaftaran/afirmasi/aksiverifikasi') ?>",
                    type: 'POST',
                    data: {
                        id: id,
                        name: name
