                    ...
                    <div class="col-lg-6 col-7">
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Jalur Mutasi</li>
                            </ol>
                        </nav>
                    </div>
                </div>
...
<script>
    ...
    function verifikasi(id) {
        $.ajax({
            url: "<?= base_url('sekolah/pendaftaran/mutasi/detail') ?>",
            type: 'POST',
            data: {
                id: id,
            },
    ...
    function saveTolakVerifikasi() {
        ...
        $.ajax({
            url: "<?= base_url('sekolah/pendaftaran/mutasi/aksitolakverifikasi') ?>",
            type: 'POST',
            data: {
                id: id,
                name: name,
    ...
    function aksiVerifikasi(id, name) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "<?= base_url('sekolah/pendaftaran/mutasi/aksiverifikasi') ?>",
                    type: 'POST',
                    data: {
                        id: id,
                        name: name
