...
<script>
    ...
    function verifikasi(id) {
        $.ajax({
            url: "<?= base_url('sekolah/pendaftaran/prestasi/detail') ?>",
            type: 'POST',
            data: {
                id: id,
            },
    ...
    function saveTolakVerifikasi() {
        ...
        $.ajax({
            url: "<?= base_url('sekolah/pendaftaran/prestasi/aksitolakverifikasi') ?>",
            type: 'POST',
            data: {
                id: id,
                name: name,
    ...
    function aksiVerifikasi(id, name) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "<?= base_url('sekolah/pendaftaran/prestasi/aksiverifikasi') ?>",
                    type: 'POST',
                    data: {
                        id: id,
                        name: name
