            ...
            <li class="list-group-item px-0">
                <div class="row align-items-center">
                    ...
                    <div class="col ml--2">
                        ...
                        <span class="badge badge-success">PRESTASI</span> &nbsp;&nbsp;<small>Jarak : <?= getJarak2Koordinat($latitude, $longitude, $value->latitude_sekolah_tujuan, $value->longitude_sekolah_tujuan, 'kilometers') . ' Km' ?></small>
