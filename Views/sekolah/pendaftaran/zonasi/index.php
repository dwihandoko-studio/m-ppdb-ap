...
<script>
    ...
    function cariData(event) {
        ...
        if (cari !== "") {
            $.ajax({
                url: "<?= base_url('sekolah/pendaftaran/zonasi/getAll') ?>",
                type: 'POST',
                data: {
                    keyword: cari,
                    page: "1",
    ...
    function verifikasi(id) {
        $.ajax({
            url: "<?= base_url('sekolah/pendaftaran/zonasi/detail') ?>",
            type: 'POST',
            data: {
                id: id,
            },
    ...
    function saveTolakVerifikasi() {
        ...
        $.ajax({
            url: "<?= base_url('sekolah/pendaftaran/zonasi/aksitolakverifikasi') ?>",
            type: 'POST',
            data: {
                id: id,
                name: name,
    ...
    function aksiVerifikasi(id, name) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "<?= base_url('sekolah/pendaftaran/zonasi/aksiverifikasi') ?>",
                    type: 'POST',
                    data: {
                        id: id,
                        name: name
