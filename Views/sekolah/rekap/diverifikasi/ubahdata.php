...
<form id="formAddData" class="form-horizontal form-add-data" method="post">
    ...
    <div class="modal-body" style="padding-top: 0px; padding-bottom: 0px;">
        <div class="col-md-12">
            <div class="form-group nisn-block">
                <label for="nisn" class="form-control-label">NISN</label>
                <input type="text" class="form-control nisn" value="<?= $data->nisn ?>" name="nisn" placeholder="nisn..." id="_latitude" onfocusin="inputFocus(this);" readonly>
                <div class="help-block nisn"></div>
            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group nama-block">
                <label for="nama" class="form-control-label">Nama Peserta</label>
                <input type="text" class="form-control nama" value="<?= str_replace("&#039;","`",str_replace("'","`",$data->fullname)) ?>" name="nama" placeholder="nama..." id="_latitude" onfocusin="inputFocus(this);" readonly>
...
<script>
    function saveAdd(event) {
        ...
        if (id === "" || latitude === "" || longitude === "") {
            ...
            $.ajax({
                url: BASE_URL + "/sekolah/rekap/diverifikasi/editSave",
                type: 'POST',
                data: {
                    id: id,
                    latitude: latitude,
