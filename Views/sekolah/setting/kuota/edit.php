<?php if (isset($data)) { ?>
        ...
        <div class="modal-body" style="padding-top: 0px; padding-bottom: 0px;">
            <div class="col-md-12">
                <div class="form-group _jumlah_kelas-block">
                    ...
                    <input type="number" value="<?= $data->jumlah_kelas ?>" class="form-control jumlah-kelas" name="_jumlah_kelas" placeholder="Jumlah ketersediaan kelas..." id="_jumlah_kelas" onfocusin="inputFocus(this);" required>
            ...
            <div class="col-md-12">
                <div class="form-group _jumlah_rombel_current-block">
                    ...
                    <input type="number" value="<?= $data->jumlah_rombel_current ?>" class="form-control jumlah-rombel-current" name="_jumlah_rombel_current" placeholder="Jumlah rombel akhir saat ini..." id="_jumlah_rombel_current" onfocusin="inputFocus(this);" required>
            ...
            <div class="col-md-12">
                <div class="form-group _jumlah_rombel_kebutuhan-block">
                    ...
                    <input type="number" value="<?= $data->jumlah_rombel_kebutuhan ?>" class="form-control jumlah-rombel-kebutuhan" name="_jumlah_rombel_kebutuhan" placeholder="Jumlah rombel_kebutuhan..." id="_jumlah_rombel_kebutuhan" onfocusin="inputFocus(this);" required>
            ...
            <div class="col-md-12">
                <div class="form-group _radius_zonasi-block">
                    ...
                    <input type="number" value="<?= $data->radius_zonasi ?>" class="form-control radius-zonasi" name="_radius_zonasi" placeholder="Radius Zonasi..." id="_radius_zonasi" onfocusin="inputFocus(this);" required>
    ...
    <script>
        function saveEdit(event) {
            ...
            if (id === "" || jumlahKelas === "" || jumlahRombelCurrent === "" || jumlahRombelKebutuhan === "" || radius === "") {
                return;
            } else {
                Swal.fire({
                    title: 'Apakah anda yakin ingin mengupdate data ini?',
                    text: "Update Kuota PPDB.",
                    ...
                    if (result.value) {
                        $.ajax({
                            url: BASE_URL + "/sekolah/setting/kuota/editSave",
                            type: 'POST',
                            data: {
                                id: id,
