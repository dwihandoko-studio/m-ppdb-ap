    ...
    <div class="modal-body" style="padding-top: 0px; padding-bottom: 0px;">
        <div class="col-md-12">
            <div class="form-group _nama_panitia-block">
                ...
                <input type="text" class="form-control nama-panitia" name="_nama_panitia" placeholder="Nama panitia..." id="_nama_panitia" onfocusin="inputFocus(this);" required>
        ...
        <div class="col-md-12">
            <div class="form-group _nohp_panitia-block">
                ...
                <input type="text" class="form-control nohp-panitia" name="_nohp_panitia" placeholder="No handphone panitia..." id="_nohp_panitia" onfocusin="inputFocus(this);" required>
...
<script>
    function saveAdd(event) {
        ...
        $.ajax({
            url: BASE_URL + "/sekolah/setting/panitia/addSave",
            type: 'POST',
            data: {
