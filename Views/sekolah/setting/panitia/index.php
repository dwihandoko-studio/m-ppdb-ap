                    ...
                    <div class="col-lg-6 col-7">
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Setting Panitia</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-lg-6 col-5 text-right">
                        <button type="button" onclick="actionAdd(this)" class="btn btn-sm btn-neutral">Tambah Panitia</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header border-0">
                        <h3 class="mb-0">Setting Panitia</h3>
                        <br>
...
<script>
    ...
    function actionDetail(event) {
        $.ajax({
            url: "<?= base_url('sekolah/setting/panitia/detail') ?>",
            type: 'POST',
            data: {
                id: event,
            },
            ...
            success: function(resul) {
                ...
                if (resul.code !== 200) {
                    ...
                    $('#contentModalLabel').html('DETAIL PANITIA');
    ...
    function actionHapus(event, title = "") {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "<?= base_url('sekolah/setting/panitia/hapus') ?>",
                    type: 'POST',
                    data: {
                        id: event,
                    },
    ...
    function actionEdit(event) {
        $.ajax({
            url: "<?= base_url('sekolah/setting/panitia/edit') ?>",
            type: 'POST',
            data: {
                id: event,
            },
            ...
            success: function(resul) {
                ...
                if (resul.code !== 200) {
                    ...
                    $('#contentModalLabel').html('EDIT PANITIA');
                    $('.contentBodyModal').html(resul.data);
                    $('#contentModal').modal({
                        backdrop: 'static',
                        keyboard: false
    ...
    function actionAdd(event) {
        $.ajax({
            url: "<?= base_url('sekolah/setting/panitia/add') ?>",
            type: 'GET',
            dataType: 'JSON',
            beforeSend: function() {
                $('div.main-content').block({
            ...
            success: function(resul) {
                ...
                if (resul.code !== 200) {
                    ...
                    $('#contentModalLabel').html('TAMBAH PANITIA');
                    $('.contentBodyModal').html(resul.data);
                    $('#contentModal').modal({
                        backdrop: 'static',
                        keyboard: false
    ...
    $(document).ready(function() {
        ...
        let tableUsulan = $('#data-table-id').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?= base_url('sekolah/setting/panitia/getAll') ?>",
                "type": "POST",
