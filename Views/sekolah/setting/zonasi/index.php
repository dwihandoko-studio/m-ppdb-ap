            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header border-0">
                        <h3 class="mb-0">Setting Zonasi</h3>
                        <br>
...
<script>
    ...
    function actionDetail(event) {
        $.ajax({
            url: "<?= base_url('sekolah/setting/zonasi/detail') ?>",
            type: 'POST',
            data: {
                id: event,
            },
    ...
    function actionHapus(event, title = "") {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "<?= base_url('sekolah/setting/zonasi/hapus') ?>",
                    type: 'POST',
                    data: {
                        id: event,
                    },
    ...
    function actionEdit(event) {
        $.ajax({
            url: "<?= base_url('sekolah/setting/zonasi/edit') ?>",
            type: 'POST',
            data: {
                id: event,
            },
    ...
    function actionAdd(event) {
        $.ajax({
            url: "<?= base_url('sekolah/setting/zonasi/add') ?>",
            type: 'GET',
            dataType: 'JSON',
            beforeSend: function() {
                $('div.main-content').block({
    ...
    $(document).ready(function() {
        ...
        let tableUsulan = $('#data-table-id').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?= base_url('sekolah/setting/zonasi/getAll') ?>",
                "type": "POST",
