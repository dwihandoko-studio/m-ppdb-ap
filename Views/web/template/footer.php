<footer class="footer-section position-relative">
    <img class="footer-bg-shape visibility-footer" style="display: block;" src="<?= base_url('template/pringo'); ?>/assets/images/footer/shape.png" alt="images_notFound" />
    <img class="path-shape visibility-footer" style="display: block;" src="<?= base_url('template/pringo'); ?>/assets/images/footer/path-shape.png" alt="images_notFound" />

    <svg class="path-svg visibility-footer" style="display: block;" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 126.82 303.68">
        <defs>
    ...
    <div class="footer-top position-relative visibility-footer" style="display: block;">
        <div class="container">
            <div class="row">
                        ...
                        <div class="footer-row">
                            <div class="footer-col">
                                <div class="footer-widget">
                                    <a class="footer-logo" href="<?= base_url() ?>">
                                        <img src="<?= base_url('template/pringo'); ?>/assets/images/logo/logo-white.png" alt="logo_not_found" />
                                    </a>
                            ...
                            <div class="footer-col">
                                <div class="footer-widget">
                                    ...
                                    <ul class="footer-menu">
                                        ...
                                        <li>
                                            <a class="footer-link" href="#">
                                                <i class="icofont-rounded-double-right"></i>Verifikasi Berkas Pendaftaran</a>
                                        </li>
                                        <li>
                                            <a class="footer-link" href="#">
                                                <i class="icofont-rounded-double-right"></i>Analisis dan Pengumuman</a>
                                        </li>
                                        <li>
                                            <a class="footer-link" href="#">
                                                <i class="icofont-rounded-double-right"></i>Pelimpahan dan Daftar Ulang</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="footer-col">
                                <div class="footer-widget">
                                    ...
                                    <p>
                                        Hubungi kami di sosial media resmi.
                                    </p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <p>
                        <!-- Copyright &copy;
                        <span id="currentYear"></span> By -->
                        Supported By :
                        <a href="<?= getenv('web.footer.url') ? getenv('web.footer.url') : 'https://kntechline.id' ?>"><?= getenv('web.footer.name') ? getenv('web.footer.name') : 'KNTechline' ?></a> All Rights Reserved
                    </p>
                </div>
            </div>
        </div>
